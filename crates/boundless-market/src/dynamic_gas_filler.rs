        ...
        if let Some(builder) = tx.as_mut_builder() {
            match params.fillable {
                ...
                GasFillable::Eip1559 { gas_limit, estimate } => {
                    ...
                    println!("                ");
                    println!("                ");
                    println!("🎯🎯🎯 adjusted_gas_limit : adjusted_gas_limit : {}", adjusted_gas_limit);
                    println!("🎯🎯🎯 adjusted_max_fee : adjusted_max_fee : {}", adjusted_max_fee);
                    println!("🎯🎯🎯 final_priority_fee : final_priority_fee : {}", final_priority_fee);
                    println!("                ");
                    println!("                ");
                    println!("________________________________________________________________");
